...
defmodule Kernel.ParserSequenceLiteralTest do
  ...
  #   test "basic identifiers now fail due to sequence_token tokens" do
  #     # The tokenizer produces {sequence_token, _, hello} which parser doesn't recognize
  ...
  #   test "mixed case identifiers fail due to sequence_token tokens" do
  #     # Both produce sequence_token tokens that parser doesn't understand
  #     assert_syntax_error(["syntax error"], "~~(CamelCase snake_case)")
  #   end

  #   test "dot notation identifiers fail due to sequence_token tokens" do
  #     # These now produce sequence_token tokens with dotted names like 'IO.puts'
  #     # but the parser doesn't recognize sequence_token tokens
  ...
  #     # sequence_token + sequence_number
  #     assert_syntax_error(["syntax error"], "~~(foo 123)")
  #     # sequence_token + sequence_atom
  #     assert_syntax_error(["syntax error"], "~~(foo :atom)")
  #     # sequence_token + sequence_string
  #     assert_syntax_error(["syntax error"], "~~(foo \"string\")")
  #     # sequence_token + sequence_token (true is now a sequence_token)
  #     assert_syntax_error(["syntax error"], "~~(foo true)")
  #     # nested parens with sequence_tokens
  ...
  #     # This fails because ~~(foo bar) produces sequence_token tokens
  #     assert_syntax_error(["syntax error"], "x = ~~(foo bar)")
  #   end

  #   test "operators fail due to sequence_token tokens" do
  #     # All operators now produce sequence_token tokens that parser doesn't recognize
  #     assert_syntax_error(["syntax error"], "~~(a + b)")
  ...
  #   test "nested parentheses fail due to sequence_token tokens" do
  #     # Even nested parentheses fail because they contain sequence_token tokens
  #     assert_syntax_error(["syntax error"], "~~((a b))")
  #     assert_syntax_error(["syntax error"], "~~((a (b c)))")
  ...
  #     # All multiline cases fail because they contain sequence_token tokens
  ...
  #     # Test that identifiers inside sequences become sequence_token tokens
  ...
  #   test "operators produce sequence_token tokens" do
  #     tokens = tokenize("~~(a + b)")
  ...
  #   test "keywords produce sequence_token tokens" do
  ...
  #     # Even empty operators fail because they become sequence_token tokens (if parsed)
